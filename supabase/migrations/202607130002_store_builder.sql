...
insert into public.store_pages (id, name, slug, title, description, active, show_in_navigation, is_home, order_index) values
  ('home', 'Página inicial', 'inicio', 'Autêntica Professional', 'Página principal da loja.', true, false, true, 1),
  ('page-about', 'Sobre nós', 'sobre', 'Sobre a Autêntica Professional', 'Conheça o projeto demonstrativo e a proposta da loja.', true, true, false, 2)
