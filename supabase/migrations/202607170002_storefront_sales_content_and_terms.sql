-- Prepara a vitrine da MV3 Catalog para operação comercial.
...
values
  (
    '00000000-0000-4000-8000-000000000100', 'banner-1', 'BEM-VINDO À MV3 CATALOG',
    ...
    'Compre na MV3 Catalog com atendimento humano', false, true, 1
  ),
  (
    ...
    'Produtos da MV3 Catalog organizados por categoria', false, true, 2
  ),
  (
...
values
  ('00000000-0000-4000-8000-000000000100', 'section-featured', 'featured', 'Produtos em destaque', 'MAIS PROCURADOS', 'Destaques da MV3 Catalog.', 'Uma seleção dos produtos mais procurados pelos nossos clientes.', '', '', true, 1),
...
set
  description = case
    when id = 'home' then 'Página principal da MV3 Catalog.'
    else 'Conheça a MV3 Catalog e nosso compromisso com uma compra transparente.'
  end,
  updated_at = now()
where tenant_id = '00000000-0000-4000-8000-000000000100'
...
values
  (
    ...
    'Mensagem institucional', 'MV3 CATALOG', 'Compra clara, atendimento próximo e pedido acompanhado.',
...
set
  ...
  body = 'A MV3 Catalog nasceu para oferecer produtos selecionados com uma experiência simples, organizada e transparente. Nossa equipe acompanha o cliente desde a escolha até a confirmação do envio.',
