...
export function buildCatalogProductGroups(
  ...
  const visibleProducts = products
    ...
    .filter((product) =>
      !term || [product.name, product.category, product.brand, product.description, product.tagline, product.need, product.activeIngredient, product.indication, product.result, ...product.audiences]
