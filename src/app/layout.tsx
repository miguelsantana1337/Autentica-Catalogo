      ...
      <head>
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem("autentica:admin-theme");if(t!=="dark"&&t!=="light"){t=matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}document.documentElement.dataset.adminTheme=t}catch(e){}})();`,
          }}
        />
      </head>
      <body>
