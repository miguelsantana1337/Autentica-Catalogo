      ...
      <div className="admin-command-grid">
        <div className="admin-command-primary">
          ...
          <section className="admin-command-panel admin-weekly-orders">
            <header><div><h2>Solicitações dos últimos 7 dias</h2><p>Atendimentos registrados pelo catálogo</p></div><Link href="/admin/orders">Ver solicitações <IconArrowRight /></Link></header>
            <div className="admin-weekly-chart" aria-label="Gráfico de pedidos dos últimos sete dias">
              ...
              {data.orders.length === 0 && <div className="admin-chart-empty"><IconShoppingCartOff /><div><strong>Nenhuma solicitação neste período</strong><p>Quando alguém pedir um orçamento, ele aparecerá aqui.</p></div><Link href="/">Abrir catálogo</Link></div>}
            </div>
          </section>
        </div>
