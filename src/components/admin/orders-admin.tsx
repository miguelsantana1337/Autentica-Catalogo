  ...
  return (
    <>
      <AdminPanel
        ...
        description="Localize solicitações, acompanhe o atendimento ou registre uma seleção feita pela equipe."
      ...
      >
        ...
        ) : <AdminEmpty><strong>Nenhuma solicitação encontrada.</strong><span>Ajuste os filtros ou envie uma solicitação pelo catálogo.</span></AdminEmpty>}
      </AdminPanel>
