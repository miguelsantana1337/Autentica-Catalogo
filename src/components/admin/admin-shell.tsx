...
import { CopilotMV3 } from "@/components/admin/copilot-mv3";
...
const titles: Record<string, [string, string]> = {
  ...
  "/admin/orders": ["OPERAÇÃO", "Solicitações comerciais"],
...
const adminThemeStorageKey = "autentica:admin-theme";
const adminSidebarStorageKey = "autentica:admin-sidebar";
        ...
        <div className="admin-sidebar-panel">
          ...
          <div className="admin-sidebar-status">
            ...
            <div className="admin-demo-card">
              <IconBox />
              <div><strong>Catálogo consultivo</strong><small>Orçamentos via WhatsApp</small></div>
            </div>
          </div>
