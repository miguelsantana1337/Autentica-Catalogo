              ...
              {!banner.imageOnly && <div className="container hero-content">
                <div className="hero-copy">
                  ...
                  <div className="hero-actions">
                    ...
                    <a className="button button-ghost button-large" href={whatsappUrl(data.settings.whatsapp, `Olá! Quero conhecer as linhas e condições da ${data.settings.storeName}.`)} target="_blank" rel="noreferrer">Falar no WhatsApp</a>
                  </div>
                </div>
              </div>}
            </article>
