...
const products = productRows.map((row, index) => {
  ...
  return {
    ...
    tagline: "Produto selecionado para o catálogo.",
    need: category.name,
    audiences: ["b2b", "b2c", "resale"] as ProductAudience[],
    indication: "Consulte a indicação completa com a equipe.",
    result: "Resultado sujeito à forma de utilização.",
...
export const seedData: StoreData = {
  ...
  customers: [
    { id: "customer-demo-1", name: "Cliente Demonstração", email: "cliente1@exemplo.com", phone: "11999990001", city: "São Paulo", state: "SP", source: "whatsapp", tags: ["recorrente"], notes: "Cadastro demonstrativo para validar a jornada de atendimento.", assignedTo: platformConfig.demoAdmin.email, whatsappConsent: true, emailConsent: true, createdAt: "2026-07-01T10:00:00-03:00", updatedAt: "2026-07-10T15:20:00-03:00" },
    { id: "customer-demo-2", name: "Maria Exemplo", email: "cliente2@exemplo.com", phone: "11999990002", city: "Campinas", state: "SP", source: "instagram", tags: ["pós-venda"], notes: "Cliente fictícia usada nos fluxos de demonstração.", assignedTo: platformConfig.demoAdmin.email, whatsappConsent: true, emailConsent: false, createdAt: "2026-07-02T09:30:00-03:00", updatedAt: "2026-07-11T11:45:00-03:00" },
    { id: "customer-demo-3", name: "João Exemplo", email: "cliente3@exemplo.com", phone: "11999990003", city: "Santos", state: "SP", source: "referral", tags: ["novo"], notes: "Cliente fictício usado nos fluxos de demonstração.", assignedTo: platformConfig.demoAdmin.email, whatsappConsent: true, emailConsent: false, createdAt: "2026-07-03T14:00:00-03:00", updatedAt: "2026-07-12T18:10:00-03:00" },
  ],
  customerTasks: [],
  customerContacts: [],
  cashbackCampaigns: [],
  ...
  orders: [
    {
      ...
      customer: { name: "Cliente Demonstração", phone: "11999990001", email: "cliente1@exemplo.com", zip: "01001-000", city: "São Paulo", state: "SP", address: "Rua Exemplo", number: "100", complement: "" },
      items: [{ productId: "produto-1", name: "Produto Essencial", quantity: 1, unitPrice: 129.9, unitCost: 78, unitCashback: 10 }],
      subtotal: 129.9,
      discount: 18.8355,
      shipping: 24.9,
      total: 135.9645,
      ...
      status: "Pago",
      couponCode,
      internalNotes: "Pedido fictício para demonstração do painel.",
      trackingCode: "",
    ...
    },
    {
      ...
      customer: { name: "Maria Exemplo", phone: "11999990002", email: "cliente2@exemplo.com", zip: "13010-000", city: "Campinas", state: "SP", address: "Avenida Demonstração", number: "45", complement: "" },
      items: [{ productId: "produto-2", name: "Produto Premium", quantity: 1, unitPrice: 219.9, unitCost: 132, unitCashback: 0 }],
      subtotal: 219.9,
      discount: 0,
      shipping: 24.9,
      total: 244.8,
    ...
    },
    {
      ...
      customer: { name: "João Exemplo", phone: "11999990003", email: "cliente3@exemplo.com", zip: "11010-000", city: "Santos", state: "SP", address: "Praça Modelo", number: "12", complement: "" },
      items: [{ productId: "produto-3", name: "Item para Casa", quantity: 2, unitPrice: 89.9, unitCost: 54, unitCashback: 0 }],
      subtotal: 179.8,
      discount: 0,
      shipping: 24.9,
      total: 204.7,
  ...
  productLots: [],
  suppliers: [
    { id: "supplier-demo-1", name: "Fornecedor Demonstração", taxId: "", email: "fornecedor@exemplo.com", phone: "11999998888", leadTimeDays: 7, notes: "Fornecedor fictício para demonstrar o módulo de compras.", active: true, createdAt: "2026-07-01T09:00:00-03:00" },
  ],
  purchaseOrders: [
    { id: "purchase-demo-1", code: "OC-1001", supplierId: "supplier-demo-1", status: "ordered", expectedAt: "2026-07-22", receivedAt: "", total: 390, notes: "Reposição fictícia para demonstrar a previsão de estoque.", items: [{ id: "purchase-item-demo-1", productId: "produto-1", name: "Produto Essencial", quantity: 5, unitCost: 78, lotCode: "DEMO-2607", expiryDate: "2027-07-31" }], createdAt: "2026-07-15T09:00:00-03:00" },
  ],
  savedReports: [],
  exportRuns: [],
