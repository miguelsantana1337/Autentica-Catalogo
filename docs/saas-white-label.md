...
Administrador da plataforma
  -> /saas
     -> MV3 Catalog -> /admin e /loja/mv3-catalog
...
- associa os dados existentes à MV3 Catalog;
...
Não execute o seed genérico sobre uma base que já possua dados da loja inicial.
Ele é destinado somente a instalações novas ou geradas separadamente.
