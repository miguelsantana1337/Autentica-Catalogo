...
loadLocalEnvironment();
const fileArgument = process.argv.find((argument) => argument.endsWith(".mv3backup"));
if (!fileArgument) throw new Error("Informe o arquivo .mv3backup.");
...
if (process.env.MV3_RESTORE_CONFIRM !== tenantSlug || envelope.tenant.slug !== tenantSlug) throw new Error(`Para restaurar, defina MV3_RESTORE_CONFIRM=${tenantSlug} e use um backup do mesmo tenant.`);
